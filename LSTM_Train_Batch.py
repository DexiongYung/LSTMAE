...
parser.add_argument('--hidden_size', help='Size of the hidden layer of LSTM', nargs='?', default=500, type=int)
...
parser.add_argument('--batch', help='Batch size', nargs='?', default=1000, type=int)
