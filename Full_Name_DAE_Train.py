...
from Full_Name_Convert import string_to_tensor, pad_string, int_to_tensor, MAX_LENGTH, ALL_CHARS, LETTERS_COUNT, char_to_index, \
    SOS, EOS, PAD
...
parser.add_argument('--train_csv', help="Path of the train csv file", nargs="?", default="Data/proper_labelled.csv", type=str)
